...
export function renderHeader({title="DQ7R データベース", subtitle=""} = {}){
  ...
  header.innerHTML = `
    <div class="header-inner">
      ...
      <div class="gsearch">
        <input id="globalSearchInput" type="search" placeholder="用語検索（ボス/職業/キャラ/アイテム/呪文/特技/メダル/ラッキーパネル/ダメージ計算/取り逃しQ&A/強モンスター/更新履歴）" autocomplete="off" />
      ...
      <nav>
        ...
        <a href="./bosses.html">ボス</a>
                <a href="./strong_monsters.html">強モンスター</a>
